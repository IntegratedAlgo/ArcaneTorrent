...
pub async fn updates(configuration: &configuration::Configuration, since: f32, r#type: Option<&str>, action: Option<&str>, page: Option<f32>) -> Result<crate::models::Updates200Response, Error<UpdatesError>> {
