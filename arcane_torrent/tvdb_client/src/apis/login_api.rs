...
pub async fn login_post(configuration: &configuration::Configuration, login_post_request: crate::models::LoginPostRequest) -> Result<crate::models::LoginPost200Response, Error<LoginPostError>> {
